...
class TeletestWorkflowContractTest extends TestCase
{
    ...
    {
        $this->artisan('iwosan:validate-teletest-workflow-contract')
            ->expectsOutput('Teletest workflow contract validation passed.')
            ->assertSuccessful();
    }
}
